...
#date            2018-06-07
#version         0.2
#usage           curl -sSL https://s3.amazonaws.com/DOC-EXAMPLE-BUCKET/v0.5/create-kubeconfig.sh | bash -s stable
#==============================================================================

# Download kubeconfig template
mkdir $HOME/.kube
aws s3 cp s3://DOC-EXAMPLE-BUCKET/v0.5/config-k8s-workshop $HOME/.kube/config
